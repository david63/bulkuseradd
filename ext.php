	...
	public function is_enableable()
 	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/bulkuseradd');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/bulkuseradd', 'ext_enable_error');
			}
		}
